    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <div class="flex items-center gap-3 px-5 py-3 rounded-xl border border-white/[0.08] bg-[#1A1A1A] hover:border-purple-500/40 hover:bg-[#1e1a2e] transition-all duration-200">
                    <span class="w-2 h-2 rounded-full bg-purple-500 shrink-0" aria-hidden="true"></span>
                    <span class="text-sm font-medium text-white">{{ $benefit->title }}</span>
                </div>
                @endforeach
            </div>
            @endif
