<header class="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-[#111111]/90 backdrop-blur-md"
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-1" aria-label="Navigasi utama">
                ...
                <a href="{{ route('contact.index') }}"
                   class="ml-4 px-5 py-2 text-sm font-semibold rounded-lg bg-[#20C997] text-[#111111] hover:bg-[#1aad82] transition-colors duration-200">
                    Hubungi Kami
                </a>
            </nav>
    ...
    <div x-show="open"
        ...
        <nav class="px-4 py-4 flex flex-col gap-1" aria-label="Navigasi mobile">
            ...
            <a href="{{ route('contact.index') }}"
               @click="open = false"
               class="mt-2 px-4 py-3 text-sm font-semibold text-center rounded-lg bg-[#20C997] text-[#111111] hover:bg-[#1aad82] transition-colors">
                Hubungi Kami
            </a>
        </nav>
    </div>
