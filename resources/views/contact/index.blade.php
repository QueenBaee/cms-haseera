                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                                <div class="w-10 h-10 rounded-lg bg-purple-500/10 border border-purple-500/20 flex items-center justify-center shrink-0">
                            ...
                            <div class="flex items-start gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $settings->email }}" class="text-sm text-[#D4D4D4] hover:text-white transition-colors">{{ $settings->email }}</a>
                                </div>
                            </div>
                            @endif
                            ...
                            @endphp
                            <div class="flex items-start gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/[0.06]">
                                <div class="w-10 h-10 rounded-lg bg-[#25D366]/10 border border-[#25D366]/20 flex items-center justify-center shrink-0">
