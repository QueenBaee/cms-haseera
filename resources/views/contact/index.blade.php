        ...
        <section class="relative pt-32 pb-16 sm:pt-36 sm:pb-20 overflow-hidden">
            ...
            <div class="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="flex flex-wrap items-center justify-center gap-3">
                    <a href="#contact-form"
                       class="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-[#111111] font-semibold text-sm hover:brightness-105 transition-all duration-200 hover:scale-105 shadow-lg shadow-black/20"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="p-5 rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-500/10 to-purple-900/10">
                            ...
                            <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer"
                               class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-[#111111] font-semibold text-sm hover:brightness-105 transition-all duration-200 hover:scale-105"
                               style="background-color: var(--btn-primary);">
                    ...
                    <div id="contact-form" class="lg:col-span-3">
                        <div class="p-6 sm:p-8 rounded-2xl border border-white/[0.07] bg-white/[0.03]">
                            ...
                            <form method="POST" action="{{ route('contact.store') }}"
                                ...
                                <button type="submit"
                                        :disabled="submitting"
                                        class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl text-[#111111] font-bold text-sm hover:brightness-105 transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-black/20 disabled:opacity-60 disabled:cursor-not-allowed disabled:scale-100"
                                        style="background-color: var(--btn-primary);">
        ...
        <div x-show="open"
            ...
            <div style="display:flex; justify-content:flex-end;">
                <button @click="open = false; $nextTick(() => { const el = document.querySelector('#contact-form-el input.border-red-500\/60, #contact-form-el textarea.border-red-500\/60'); if(el) el.focus(); })"
                        style="background-color: var(--btn-primary); font-weight:600; font-size:13.5px; padding:0 22px; height:42px; border-radius:11px; transition:filter 0.15s, transform 0.15s; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.20);"
                        class="text-[#111111] hover:brightness-105 hover:scale-[1.02]">
                    Periksa Kembali
                </button>
            </div>
        </div>
